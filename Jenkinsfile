...
pipeline{
    ...
    environment {
        ...
        COMPONENT = "projet-isa-devops-20-team-b-20-invoice-component"
        VERSION = """${sh(
                            returnStdout: true,
        ...
        stage('New Version To check') {
            ...
            stages {
                ...
                stage('Update snapshot dependencies') {
                    ...
                    steps {
                        script {
                            def components = ['projet-isa-devops-20-team-b-20-warehouse-component','projet-isa-devops-20-team-b-20-web-service']
